      ...
      <div className="carousel w-full">
        <div id="slide1" className="carousel-item relative w-full">
          ...
          <div className="absolute flex justify-between  transform -translate-y-1/2 left-5 right-5 top-1/2">
            <h1 className="md:text-5xl text-xl bg-black bg-opacity-30 text-white font-bold font-serif md:p-24 text-start">WELCOME
              <br />
              <span >TO THE</span>
              <br />
              <span>CAR STORE</span>
        ...
        <div id="slide2" className="carousel-item relative w-full">
          ...
          <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            <h1 className="md:text-5xl text-xl bg-black bg-opacity-30 text-white font-bold font-serif md:p-24 text-start">
            This Is <br /> Red Mini             
            </h1>
            <div className=' flex justify-center items-end gap-5 '>
        ...
        <div id="slide3" className="carousel-item relative w-full">
          ...
          <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            <h1 className="md:text-5xl text-xl bg-black bg-opacity-30 text-white font-bold font-serif md:p-24 text-start">New <br />Latest Car <br />White Jeep 
            </h1>
            <div className=' flex justify-center items-end gap-5 '>
              <a href="#slide2" className="btn btn-circle bg-gradient-to-r from-cyan-500 to-blue-500">❮</a>
              <a href="#slide4" className="btn btn-circle bg-gradient-to-r from-cyan-500 to-blue-500">❯</a>
