...
const Footer = () => {
    return (
        <>
            ...
            <footer className="footer px-10 py-4 border-t bg-gradient-to-r from-cyan-500 to-blue-500  border-base-300 text-black">
                ...
                <div className="md:place-self-center md:justify-self-end">
                    ...
                    <p>Copyright © 2022 - All right reserved by Car Store Ltd</p>
                </div>
            </footer>
        </>
    );
